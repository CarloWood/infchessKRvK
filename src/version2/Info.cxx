...
void Info::black_to_move_set_maximum_ply_on_parents(info_nodes_type::index_type current, info_nodes_type& infos, std::vector<Board>& parents_out)
{
  ...
  for (int i = 0; i < number_of_parents; ++i)
  {
    ...
    Info& parent_info = infos[parent.as_index()];
